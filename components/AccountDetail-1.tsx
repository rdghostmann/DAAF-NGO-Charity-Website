  ...
  return (
    ...
    >
      <Card className="border-2 border-slate-200 shadow-lg overflow-hidden">
        <div className="bg-gradient-to-r from-slate-700 to-slate-900 h-16 relative">
          <div className="absolute -bottom-8 left-6">
            <div className="bg-white p-3 rounded-full shadow-md">
              <Bank className="h-10 w-10 text-slate-700" />
            </div>
          </div>
        </div>
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <p className="text-lg font-semibold text-slate-800">{accountInfo.name}</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between">
              <p className="text-xl font-mono font-bold tracking-wider text-slate-800">{accountInfo.number}</p>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div>
            ...
            <p className="text-lg font-semibold text-slate-800">{accountInfo.bank}</p>
          </div>
          ...
          <div className="bg-slate-50 p-4 rounded-lg mt-4">
            <p className="text-sm text-slate-600 italic">
              Your generous donations help us continue our mission of serving and empowering vulnerable individuals and
              communities.
            </p>
          </div>
        </CardContent>
